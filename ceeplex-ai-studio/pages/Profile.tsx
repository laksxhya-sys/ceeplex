...
export const Profile = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 pb-24">
      {/* Profile Header */}
      <div className="glass rounded-3xl p-8 mb-8 flex flex-col md:flex-row items-center gap-8 border border-white/5">
        <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-brand-400 to-purple-500 p-1 shadow-2xl">
           <div className="w-full h-full rounded-full bg-dark-surface flex items-center justify-center text-3xl font-bold text-white uppercase">
              {user.name.charAt(0)}
           </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
              <div className="flex items-center gap-4">
                 <div className="p-2 bg-white/5 rounded-lg"><ImageIcon size={20} className="text-brand-400" /></div>
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {images.map(img => (
                    <div key={img.id} className="group relative bg-dark-surface rounded-2xl overflow-hidden border border-white/5 hover:border-white/20 transition-all">
          ...
          <div className="space-y-6">
              ...
              <div className="bg-dark-surface border border-white/5 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                      <div className="flex items-center justify-between p-3 bg-white/5 rounded-xl">
                          ...
                          {user.role === UserRole.ADMIN && <Shield size={16} className="text-brand-500" />}
                      </div>

                      <button onClick={handleLogout} className="w-full py-3 bg-red-500/10 text-red-400 hover:bg-red-500 hover:text-white rounded-xl transition-colors flex items-center justify-center gap-2 font-medium text-sm">
              ...
              <div className="bg-gradient-to-br from-brand-900/20 to-purple-900/20 border border-white/5 rounded-2xl p-6 text-center">
                  <p className="text-xs font-bold uppercase tracking-widest text-brand-400 mb-4">Trainer & Creator</p>
                  <div className="w-16 h-16 mx-auto mb-3 flex items-center justify-center">
                      <img src="https://iili.io/fpcnLLQ.png" className="w-full h-full object-contain" alt="Logo"/>
                  </div>
                  <h3 className="text-lg font-bold text-white mb-1">Lakshya Baradiya</h3>
                  <p className="text-xs text-slate-500 mb-4">Lead Developer & AI Trainer</p>
                  
                  <div className="space-y-2 text-sm text-slate-400">
                      <a href="https://instagram.com/__laksxhya__" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 hover:text-white transition-colors p-2 bg-white/5 rounded-lg">
                          <Instagram size={16} /> @__laksxhya__
                      </a>
                      <a href="https://instagram.com/ceeplex" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 hover:text-white transition-colors p-2 bg-white/5 rounded-lg">
                          <Instagram size={16} /> @ceeplex
                      </a>
                      <div className="flex items-center justify-center gap-2 p-2 bg-white/5 rounded-lg">
                          <Phone size={16} /> +916268716414
                      </div>
                       <div className="flex items-center justify-center gap-2 p-2 bg-white/5 rounded-lg text-xs">
